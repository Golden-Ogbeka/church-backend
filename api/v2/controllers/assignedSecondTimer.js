...
const { AssignedSecondTimerModel } = require('../models/assignedSecondTimer');
const { Op } = require('sequelize');

const Controller = () => {
  const GetAllAssignedSecondTimers = async (req, res) => {
    try {
  ...
  const GetAssignedSecondTimersByStatus = async (req, res) => {
    try {
      // check for validation errors
      const errors = validationResult(req);
      if (!errors.isEmpty())
  ...
  const GetAssignedSecondTimer = async (req, res) => {
    try {
      // check for validation errors
      const errors = validationResult(req);
      if (!errors.isEmpty())
  ...
  const GetAssignedSecondTimerForLeader = async (req, res) => {
    try {
      // check for validation errors
      const errors = validationResult(req);
      if (!errors.isEmpty())
  ...
  const AssignSecondTimer = async (req, res) => {
    try {
      // check for validation errors
      const errors = validationResult(req);
      if (!errors.isEmpty())
  ...
  const UpdateAssignedSecondTimer = async (req, res) => {
    try {
      // check for validation errors
      const errors = validationResult(req);
      if (!errors.isEmpty())
  ...
  const DeleteAssignedSecondTimer = async (req, res) => {
    try {
      // check for validation errors
      const errors = validationResult(req);
      if (!errors.isEmpty())
